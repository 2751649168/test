...
<body>
		...
		<div class="panel admin-panel">
			...
			<table class="table table-hover text-center" style="font-size:16px;" >
				...
				<c:forEach var="course" items="${xuanxiu}" varStatus="status"  >
				<tr>
					<td>${status.count}</td>
					<td>${course.cname}</td>
					...
					<td>${course.cnote}</td>
					<td>
					<a  href="${pageContext.request.contextPath}/inset?cid=${course.cid}"  class="button bg-main icon-check-square-o"  
