...
<div class="leftnav" style="font-size:16px">
  ...
  <ul style="display:block">
    <li><a href="userstudentlist2.jsp" target="right"><span class="icon-caret-right"></span>个人中心</a></li>
  ...
  <ul >
    <li><a href="${pageContext.request.contextPath}/must" target="right"><span class="icon-caret-right"></span>必修课</a></li>
    <li><a href="${pageContext.request.contextPath}/XuanXiu" target="right"><span class="icon-caret-right"></span>选修课</a></li>        
    <li><a href="${pageContext.request.contextPath}/getalls" target="right"><span class="icon-caret-right"></span>我的课程</a></li>        
  </ul>  
</div>
